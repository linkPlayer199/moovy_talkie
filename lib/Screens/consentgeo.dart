            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Text('    Consent to: geolocalization',style: TextStyle(fontSize: 18, color: Colors.black),),
                    ],
                  ),
              ...
              children: [
                InkWell(
                  onTap: (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ConsentNotification()),
                    );
                  },
                  child: Container(
